...
#while true; do lt --subdomain amsterdamcrowdcounter --port 7860 && break; done
while true; do onboardbase tunnels:create -p 7860 -s amsterdamcrowdcounter && break; done